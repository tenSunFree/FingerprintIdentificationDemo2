...
public class BiometricPromptManager {
    ...
    public boolean hasEnrolledFingerprints() {
        if (isAboveApi28()) {
            Log.d("more", "BiometricPromptManager, hasEnrolledFingerprints, 28");
            ...
            Log.d("more", "BiometricPromptManager, hasEnrolledFingerprints, 23");
            return ((BiometricPromptApi23)mImpl).hasEnrolledFingerprints();
        } else {
            Log.d("more", "BiometricPromptManager, hasEnrolledFingerprints, false");
            return false;
        }
    }
